...
from edanalyzer.models.mol_autoencoder import LitMolAutoencoder
...
def main(config_path, batch_size=12, num_workers=None):
    ...
    # Get the model
    model = LitMolAutoencoder()

    # Train
    checkpoint_callback = ModelCheckpoint(dirpath='output/mol_autoencoder')
    logger = CSVLogger("output/mol_autoencoder/logs")
