...
from edanalyzer.datasets.build_scoring_4 import BuildScoringDataset
...
def main(config_path, batch_size=12, num_workers=None):
    ...
    output = output_dir / 'build_scoring_prod_nsys=87_opt=adamw_ls=2.5e-2_bs=128_lr=e-2_wd=e-4_sch=pl_cd=10_wn=0.25_msk=7.5'
    try:
