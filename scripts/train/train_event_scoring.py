...
def main(config_path, batch_size=12, num_workers=None):
    ...
    checkpoint_callback = ModelCheckpoint(dirpath='output/event_scoring_opt=sgd_ls=2.5e-2_bs=12_lr=e-1_wd=e-5_sch=pl_cd=5')
    logger = CSVLogger("output/event_scoring_opt=sgd_ls=2.5e-2_bs=12_lr=e-1_wd=e-5_sch=pl_cd=5/logs")
