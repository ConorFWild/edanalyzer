...
def main(config_path, batch_size=12, num_workers=None):
    ...
    checkpoint_callback = ModelCheckpoint(dirpath='output/event_scoring_lig_annotations_med_lr')
    logger = CSVLogger("output/event_scoring_lig_annotations_med_lr/logs")
