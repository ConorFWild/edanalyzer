...
def main(config_path, batch_size=12, num_workers=None):
    ...
    checkpoint_callback = ModelCheckpoint(dirpath='output/event_scoring_frag_attention_adam_ht')
    logger = CSVLogger("output/event_scoring_frag_attention_adam_ht/logs")
