...
PANDDA_SUBMIT_COMMAND = 'module load global/cluster; sbatch --cpus-per-task={num_cpus} --mem-per-cpu={m_mem_free}G --output={out_path} --error={err_path} --partition=cs05r {script_path}'
