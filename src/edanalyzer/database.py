...
def parse_inspect_table_row(row, pandda_dir, pandda_processed_datasets_dir, model_building_dir, annotation_type="auto"):
...
def parse_inspect_table_row_with_build_centroid(row, pandda_dir, pandda_processed_datasets_dir, model_building_dir, annotation_type):
    dtag = str(row[constants.PANDDA_INSPECT_DTAG])
    event_idx = row[constants.PANDDA_INSPECT_EVENT_IDX]
    bdc = row[constants.PANDDA_INSPECT_BDC]
    x = row[constants.PANDDA_INSPECT_X]
