    ...
    def __getitem__(self, idx: int):
        ...
        return (
            [
                ...
                _z,
                _f,
                str( self.pandda_2_z_map_sample_metadata_table['system']),
                str( self.pandda_2_z_map_sample_metadata_table['dtag']),
                int( self.pandda_2_z_map_sample_metadata_table['event_num']),
             ],
